package com.atcumt.ai.controller.user.v2;
...
@RestController("aiControllerV2")
@RequestMapping("/api/ai/user/v2")
@Tag(name = "AI", description = "AI相关接口V2")
...
public class AiController {
    ...
    public Flux<ChatResponse> getConversation(@RequestBody ConversationDTO conversationDTO) throws Exception {
